...
export const appointmentPageStyles = {
  ...
  pageContainer:
    "min-h-screen font-serif bg-gradient-to-br from-green-50 to-emerald-100 py-10 px-4",
  ...
  // Grid layouts
  doctorGrid:
    "grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12",
  serviceGrid:
    "grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 lg:grid-cols-4 gap-10",
};

export const cardStyles = {
  // Doctor appointment card
  doctorCard:
    "bg-white border border-emerald-200 rounded-2xl p-6 shadow-md hover:shadow-emerald-400 transform hover:-translate-y-2 transition-all duration-300 flex flex-col items-center",
  serviceCard: "bg-white border border-blue-200 rounded-2xl p-6 shadow-md",

  // Image containers
  doctorImageContainer:
    "w-28 h-28 rounded-full border-4 border-emerald-300 shadow-md bg-emerald-50 flex items-center justify-center overflow-hidden",
  serviceImageContainer:
    "w-28 h-28 rounded-full border-4 border-blue-300 mx-auto bg-blue-50 flex items-center justify-center overflow-hidden",
  ...
  // Text styles
  doctorName:
    "text-xl md:text-sm xl:text-md whitespace-nowrap lg:text-lg font-semibold mt-4 text-center",
  serviceName:
    "text-xl md:text-sm lg:text-md xl:text-lg font-semibold text-center mt-4",
  ...
  dateContainer:
    "mt-4 rounded-full border bg-emerald-50 border-emerald-200 py-1 px-3 w-full flex justify-center gap-2",
  serviceDateContainer:
    "mt-4 rounded-full border bg-blue-50 border-blue-200 py-1 px-3 flex justify-center gap-2 text-sm",
  timeContainer:
    "mt-2 rounded-full border bg-emerald-50 border-emerald-200 py-1 px-3 w-full flex justify-center gap-2",
  serviceTimeContainer:
    "mt-2 rounded-full border bg-blue-50 border-blue-200 py-1 px-3 flex justify-center gap-2 text-sm",
  ...
  serviceRescheduledText:
    "mt-3 text-center xl:text-md xl:whitespace-nowrap text-sm text-blue-700",
...
export const badgeStyles = {
  paymentBadge: {
    online:
      "px-3 py-1 rounded-full font-semibold text-xs bg-green-100 text-green-700 border border-green-300 flex items-center gap-1",
  ...
  statusBadge: {
    completed:
      "px-3 py-1 rounded-full font-semibold text-xs bg-slate-100 text-slate-700 border border-slate-200 flex items-center gap-1",
    confirmed:
      "px-3 py-1 rounded-full font-semibold text-xs bg-green-100 text-green-700 border border-green-200 flex items-center gap-1",
    pending:
      "px-3 py-1 rounded-full font-semibold text-xs bg-yellow-100 text-yellow-700 border border-yellow-200 flex items-center gap-1",
    canceled:
      "px-3 py-1 rounded-full font-semibold text-xs bg-red-100 text-red-700 border border-red-200 flex items-center gap-1",
    default:
      "px-3 py-1 rounded-full font-semibold text-xs bg-blue-100 text-blue-700 border border-blue-200 flex items-center gap-1",
  },
};
...
export const bannerStyles = {
  ...
  outerAnimatedBand:
    "absolute inset-0 rounded-3xl bg-gradient-to-r from-green-400 via-emerald-500 to-green-400 animate-[spin_3s_linear_infinite] opacity-80",
  ...
  headerBadgeContainer:
    "flex flex-col lg:flex-row items-center justify-center lg:justify-start mb-4 lg:mb-6 gap-4",
  stethoscopeContainer: "relative",
  stethoscopeInner:
    "relative bg-gradient-to-br from-green-300 to-emerald-600 p-3 rounded-full shadow-lg transform -rotate-6 hover:rotate-0 transition-transform duration-300",
  stethoscopeIcon: "w-7 h-7 text-white",

  // Title styles
  titleContainer: "font-[pacifico]",
  title:
    "text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-1",
  titleGradient:
  ...
  // Tagline
  tagline:
    "text-lg sm:text-xl md:text-2xl lg:text-3xl font-light text-gray-700 mb-5 leading-tight",
  taglineHighlight: "text-green-600 font-semibold",

  // Features grid
  featuresGrid:
    "grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6 text-sm sm:text-base",
  featureItem:
    "flex items-center justify-center lg:justify-start bg-gradient-to-br from-green-500 to-green-200 backdrop-blur-sm p-3 rounded-full shadow-sm border",
  ...
  bookButton:
    "group relative lg:whitespace-nowrap bg-gradient-to-r from-green-500 to-emerald-300 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-full font-semibold transform transition-all duration-300 shadow-2xl hover:shadow-3xl overflow-hidden text-sm sm:text-base",
  bookButtonOverlay:
    "absolute inset-0 bg-white/20 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000",
  bookButtonContent: "relative flex items-center justify-center gap-2",
  bookButtonIcon: "w-4 h-4 sm:w-5 sm:h-5",

  // Emergency call button
  emergencyButton:
    "group border-2 lg:whitespace-nowrap border-red-400 text-red-600 bg-red-300 px-6 py-3 sm:px-8 sm:py-4 rounded-full font-semibold transform transition-all duration-300 backdrop-blur-sm hover:shadow-lg hover:bg-red-400/80 text-sm sm:text-base",
  ...
  imageFrame:
    "relative transform transition-transform duration-500 overflow-hidden rounded-xl",
  image:
    "w-full object-cover h-56 sm:h-72 md:h-96 lg:h-[360px] xl:h-[420px] transition-transform duration-700",
};
...
export const certificationStyles = {
  // Container styles
  container:
    "relative py-6 bg-gradient-to-brfrom-emerald-50 via-green-50 to-teal-50 overflow-hidden",

  // Background styles
  backgroundGrid: "absolute inset-0",
  topLine:
    "absolute top-0 left-0 w-full h-1 bg-gradient-to-br from-transparent via-green-400 to-transparent opacity-60",
  ...
  leftLine:
    "absolute -left-20 top-1/2 w-16 h-0.5 bg-gradient-to-br from-transparent to-green-400",
  rightLine:
    "absolute -right-20 top-1/2 w-16 h-0.5 bg-gradient-to-br from-transparent to-teal-400",
  title: "text-3xl lg:text-6xl font-serif text-gray-900 mb-4 tracking-tight",
  titleText:
    "bg-gradient-to-br from-green-600 via-teal-600 to-emerald-600 bg-clip-text text-transparent",
  subtitle:
    "text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed font-light tracking-wide",
  badgeContainer:
    "inline-flex items-center px-5 py-2.5 bg-green-500/10 border border-green-400/30 rounded-full mt-6 backdrop-blur-sm",
  ...
  logoItem:
    "inline-flex flex-col items-center mx-10 transform transition-all duration-500 group",
  logoImage: "w-16 h-16 object-contain filter transition-all duration-500",
  logoText:
    "mt-3 font-serif italic text-sm font-semibold text-gray-700 text-center max-w-[120px] leading-tight group-hover:text-green-700 transition-colors duration-300",
...
export const contactPageStyles = {
  // Page container
  pageContainer:
    "min-h-screen bg-gradient-to-br from-emerald-100 via-white to-emerald-50 py-12 px-4 sm:px-6 md:px-8 lg:px-20 font-serif relative overflow-hidden",
  ...
  // Hours container
  hoursContainer:
    "bg-gradient-to-br from-emerald-200 to-emerald-100 rounded-2xl p-4 shadow-inner border border-emerald-300",
...
export const doctorsPageStyles = {
  // Main container
  mainContainer:
    "min-h-screen bg-gradient-to-br from-emerald-50 to-teal-100 py-8 sm:py-10 px-3 sm:px-6 relative overflow-hidden",
  ...
  backgroundShape2:
    "absolute -bottom-40 -left-32 w-72 h-72 sm:w-96 sm:h-96 bg-teal-200 rounded-full mix-blend-multiply filter blur-2xl opacity-30 animate-pulse animation-delay-2000",
  ...
  headerTitle:
    "text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-emerald-700 to-teal-600 bg-clip-text text-transparent mb-3 tracking-tight",
  ...
  searchWrapper:
    "relative w-full max-w-xl transition-all duration-500 px-2 sm:px-0",
  searchInput:
    "w-full py-3 sm:py-4 pl-12 pr-10 text-sm sm:text-lg rounded-full border border-emerald-300 bg-white/90 text-emerald-800 placeholder-emerald-400 shadow-md sm:shadow-lg focus:outline-none focus:ring-2 focus:ring-emerald-400/40 focus:shadow-xl transition-all duration-300 hover:shadow-2xl",
  searchIcon:
    "absolute left-4 top-3 sm:top-4 text-emerald-600 w-5 h-5 sm:w-6 sm:h-6",
  clearButton:
    "absolute right-3 top-3 sm:top-4 text-emerald-600 hover:text-emerald-800 transition",
  ...
  // Loading skeleton
  skeletonGrid:
    "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-8",
  skeletonCard:
    "animate-pulse bg-white/80 backdrop-blur-md rounded-3xl p-4 sm:p-5 md:p-6 text-center transition-all duration-300",
  skeletonImage:
    "relative mx-auto mb-4 w-28 h-28 sm:w-32 sm:h-32 md:w-36 md:h-36 lg:w-36 lg:h-36 bg-emerald-100 rounded-full",
  ...
  // Doctors grid
  doctorsGrid:
    "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-6 sm:gap-8 transition-all duration-300",
  ...
  imageContainer:
    "relative mx-auto mb-4 w-28 h-28 sm:w-32 sm:h-32 md:w-36 md:h-36 lg:w-36 lg:h-36",
  imageContainerUnavailable: "opacity-70 cursor-not-allowed",
  doctorImage:
    "w-full h-full rounded-full object-cover border-4 border-emerald-200 shadow-lg transform transition-transform duration-300 group-hover:scale-105",
  doctorImageUnavailable: "border-4 border-gray-300 shadow-md",

  // Doctor info
  doctorName:
    "text-base sm:text-lg md:text-md whitespace-nowrap lg:text-lg font-bold text-emerald-900 mb-1",
  doctorSpecialization:
    "text-sm sm:text-sm md:text-sm text-emerald-600 font-medium mb-3",

  // Experience badge
  experienceBadge:
    "inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium mb-4 bg-emerald-50 border border-emerald-300 shadow-sm",
  experienceIcon: "w-4 h-4",

  // Book button (available)
  bookButton:
    "w-full inline-flex items-center justify-center gap-2 py-2 rounded-full font-medium transition-all duration-300 text-sm bg-gradient-to-r from-emerald-300 to-teal-500 text-white hover:shadow-lg",
  bookButtonIcon: "w-5 h-5",

  // Not available button
  notAvailableButton:
    "w-full inline-flex items-center justify-center gap-2 py-2 rounded-full font-medium bg-gray-300 text-gray-600 cursor-not-allowed text-sm",
  notAvailableIcon: "w-5 h-5",

  // No results
  noResults:
    "col-span-full text-center py-10 text-emerald-800 font-medium text-base animate-fade-in",

  // Show more button
  showMoreContainer: "flex justify-center mt-8 sm:mt-10",
  showMoreButton:
    "flex items-center cursor-pointer gap-2 px-5 py-2.5 bg-gradient-to-r from-emerald-400 to-teal-500 text-white rounded-full text-md font-semibold shadow-md hover:shadow-lg transition-all duration-300",
  showMoreIcon: "w-5 h-5",

  // Link focus styles
  focusRing:
    "focus:outline-none focus:ring-2 focus:ring-emerald-300 rounded-full",
...
export const footerStyles = {
  // Main container
  footerContainer:
    "relative font-serif bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 border-t border-emerald-200 overflow-hidden",
  ...
  // Main content
  mainContent:
    "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16 relative z-10",
  gridContainer:
    "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 lg:gap-12 mb-10 text-center lg:text-left",

  // Company info
  companySection: "lg:col-span-1 flex flex-col items-center lg:items-start",
  logoContainer:
    "flex items-center space-x-5 mb-6 transform transition-transform duration-500",
  logoWrapper: "relative",
  logoImageContainer:
    "relative w-16 h-16 md:w-18 md:h-18 lg:w-20 lg:h-20 p-1 transform transition-transform duration-500",
  logoImage: "w-full h-full object-contain",
  companyName:
    "text-2xl md:text-3xl lg:text-3xl font-bold bg-gradient-to-r from-emerald-600 to-green-700 bg-clip-text text-transparent font-['Poppins'] tracking-tight",
  companyTagline:
    "text-emerald-600 font-serif text-xs md:text-sm font-semibold tracking-wide mt-1",
  companyDescription:
    "text-emerald-700 font-serif italic mb-5 leading-relaxed text-sm md:text-base font-light",

  // Contact info
  contactContainer: "space-y-3 w-full md:w-auto",
  contactItem:
    "flex items-center justify-center md:justify-start space-x-4 text-emerald-700 hover:text-emerald-800 transition-all duration-300 group transform hover:translate-x-0 md:hover:translate-x-2",
  contactIconWrapper:
    "w-9 h-9 md:w-10 md:h-10 bg-emerald-100 rounded-full flex items-center justify-center transition-colors duration-300 shadow-sm",
  ...
  sectionTitle:
    "text-lg md:text-xl font-bold text-emerald-800 mb-6 relative inline-block",
  linksList: "space-y-2",
  linkItem: "w-full",

  // Quick Links
  quickLink:
    "flex items-center justify-center md:justify-start text-emerald-700 hover:text-emerald-800 transition-all duration-300 group text-sm md:text-base font-medium py-2 px-3 rounded-lg hover:bg-emerald-50 border border-transparent hover:border-emerald-200",
  quickLinkIconWrapper:
    "w-7 h-7 bg-emerald-100 rounded-full flex items-center justify-center mr-3",
  quickLinkIcon: "w-3 h-3 text-emerald-600",

  // Services
  serviceLink:
    "flex items-center justify-center md:justify-start text-emerald-700 hover:text-green-700 transition-all duration-300 group text-sm md:text-base font-medium py-2 px-3 rounded-lg hover:bg-green-50 border border-transparent hover:border-green-200",
  ...
  newsletterDescription:
    "text-emerald-700 text-sm md:text-base mb-4 font-light text-center lg:text-left",
  newsletterForm: "w-full max-w-md",

  // Mobile newsletter
  mobileNewsletterContainer: "flex flex-col gap-3 lg:hidden",
  emailInput:
    "w-full px-4 py-3 text-base text-emerald-800 bg-white border-2 border-emerald-200 rounded-full focus:outline-none focus:ring-4 focus:ring-emerald-300 focus:border-emerald-400 transition-all duration-300 shadow-sm placeholder-emerald-400",
  mobileSubscribeButton:
    "w-full inline-flex items-center justify-center gap-2 py-3 rounded-full bg-gradient-to-r from-emerald-500 to-green-600 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300",
  mobileButtonIcon: "w-4 h-4",

  // Desktop newsletter
  desktopNewsletterContainer: "relative hidden lg:block",
  desktopEmailInput:
    "w-full px-4 py-4 text-base text-emerald-800 bg-white border-2 border-emerald-200 rounded-full focus:outline-none focus:ring-4 focus:ring-emerald-300 focus:border-emerald-400 transition-all duration-300 transform shadow-lg placeholder-emerald-400",
  desktopSubscribeButton:
    "absolute right-2 xl:px-2 top-2 bg-gradient-to-r from-emerald-500 to-green-600 text-white px-4 py-2 rounded-full cursor-pointer transition-all duration-300 transform flex items-center shadow-lg hover:shadow-xl",
  ...
  socialIconBackground:
    "absolute inset-0 bg-gradient-to-r from-emerald-400 to-green-500 rounded-full transform scale-0 group-hover:scale-110 transition-transform duration-300 hidden lg:block",
  socialIcon:
    "w-10 h-10 md:w-11 md:h-11 lg:w-12 lg:h-12 p-2 text-emerald-700 cursor-pointer transform hover:scale-110 hover:rotate-6 transition-all duration-300 relative z-10 bg-white rounded-2xl shadow-lg border-2 border-emerald-100",
...
export const homeDoctorsStyles = {
  // Section container
  section: "py-10 bg-gradient-to-br from-green-50 to-blue-50",
  ...
  // Doctor card
  article:
    "group relative bg-white rounded-3xl shadow-md hover:shadow-2xl transition transform duration-300 overflow-hidden",

  // Image containers
  imageContainerAvailable:
    "relative h-60 sm:h-44 md:h-48 lg:h-52 overflow-hidden rounded-t-3xl",
  imageContainerUnavailable:
    "relative h-60 sm:h-44 md:h-48 lg:h-52 overflow-hidden rounded-t-3xl opacity-80 cursor-not-allowed",
  image:
    "w-full h-full object-cover object-center transform transition-transform duration-500",
  unavailableBadge:
    "absolute top-3 left-3 bg-rose-50 text-rose-700 text-xs px-2 py-1 rounded-full shadow",

  // Card body
  cardBody: "p-3 sm:p-4 md:p-5 font-serif",
  doctorName:
    "text-base sm:text-lg md:text-sm lg:text-md xl:text-xl font-semibold text-black",
  specialization:
    "text-sm sm:text-sm md:text-sm text-emerald-600 font-medium mt-1",

  // Experience badge
  experienceContainer:
    "mt-3 flex items-center justify-between text-sm text-gray-600",
  experienceBadge:
    "flex items-center gap-2 border border-green-300 bg-green-100 px-2 py-1 rounded-full text-xs sm:text-sm",

  // Buttons
  buttonContainer: "mt-3",
  buttonAvailable:
    "w-full inline-flex items-center justify-center gap-2 py-2.5 sm:py-3 rounded-full font-medium transition-all duration-300 text-sm bg-gradient-to-br from-emerald-300 to-teal-500 text-white hover:shadow-lg",
  buttonUnavailable:
    "w-full inline-flex items-center justify-center gap-2 py-2.5 sm:py-3 rounded-full font-medium bg-gray-300 text-gray-600 cursor-not-allowed text-sm",
...
export const loginPageStyles = {
  // Main container
  mainContainer:
    "min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-emerald-100 to-green-200 relative font-serif overflow-hidden",

  // Back button
  backButton:
    "absolute top-6 left-6 cursor-pointer flex items-center gap-2 text-green-800 font-semibold hover:text-green-600 transition-all duration-300",
  backButtonIcon: "w-5 h-5",

  // Login card
  loginCard:
    "relative z-10 bg-white/60 backdrop-blur-xl shadow-2xl rounded-3xl p-8 w-[90%] max-w-md border border-green-200 transition-all duration-500 hover:shadow-green-300/50",
  ...
  // Submit button
  submitButton:
    "w-full py-3 bg-gradient-to-r from-emerald-400 to-green-600 text-white font-semibold rounded-full",
...
export const navbarStyles = {
  // Main container
  navbarContainer:
    "sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-emerald-100 transition-transform duration-500",
  ...
  logoTitle:
    "text-2xl md:text-2xl lg:text-2xl xl:text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-emerald-600 to-green-600 tracking-tight",
  ...
  // Signed out buttons
  doctorAdminButton:
    "btn-add hidden lg:inline-flex items-center gap-2 px-3 py-2 rounded-full text-sm font-semibold transition-transform duration-200",
  doctorAdminIcon: "w-4 h-4",
  doctorAdminText: "hidden lg:text-xs lg:whitespace-nowrap sm:inline-block",
  loginButton:
    "btn-login hidden lg:flex lg:text-sm items-center gap-2 bg-gradient-to-r from-emerald-400 to-green-600 text-white px-6 py-2.5 rounded-full font-semibold hover:shadow-xl transition-all duration-300 cursor-default",
  loginIcon: "w-4 h-4",

  // Mobile toggle
  mobileToggle:
    "lg:hidden p-2.5 rounded-lg hover:bg-emerald-50 transition-colors",
  ...
  mobileLoginButton:
    "w-full cursor-default md:rounded-full flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-500 to-green-600 text-white py-2.5 rounded-lg font-semibold hover:shadow-lg transition-all",
...
export const servicePageStyles = {
  // Page container
  pageContainer:
    "min-h-screen py-12 px-6 lg:px-20 font-serif bg-gradient-to-b from-emerald-50 to-white",
  maxWidthContainer: "max-w-6xl mx-auto",
  ...
  // Loading skeleton
  skeletonGrid:
    "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-8",
  skeletonCard:
    "animate-pulse group rounded-2xl overflow-hidden bg-white shadow-xl p-4",
  ...
  // Empty state
  emptyState:
    "col-span-full text-center py-10 text-emerald-800 font-medium text-base",
};
...
export const serviceCardStyles = {
  ...
  // Image container
  imageContainer:
    "w-full overflow-hidden bg-emerald-50/30 flex items-center justify-center",

  // Images
  picture: "w-full",
  responsiveImage:
    "w-full h-40 sm:h-48 md:h-56 lg:h-60 object-cover object-center transform group-hover:scale-105 transition-transform duration-500",
  fallbackImage:
    "w-full h-60 sm:h-48 md:h-56 lg:h-60 object-cover object-center transform transition-transform duration-500",

  // Content
  content: "p-5 text-center",
  serviceName:
    "text-lg md:text-sm whitespace-nowrap font-semibold font-serif text-emerald-900",

  // Buttons
  buttonContainer: "mt-4",
  buttonAvailable:
    "inline-flex items-center justify-center gap-2 px-5 py-2 w-full rounded-full bg-emerald-500 text-white font-medium",
  buttonUnavailable:
    "px-5 py-2 w-full flex items-center justify-center gap-2 rounded-full bg-gray-200 text-gray-500 cursor-not-allowed border",
};
...
export const testimonialStyles = {
  // Main container
  container:
    "min-h-[70vh] bg-gradient-to-br from-slate-50 to-blue-50 py-10 px-4 relative overflow-hidden",

  // Header
  headerContainer: "max-w-6xl font-serif mx-auto text-center mb-8 sm:mb-12",
  title:
    "text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-blue-600 to-green-600 mb-3",
  ...
  // Column container
  columnContainer:
    "relative font-serif border-2 rounded-2xl overflow-hidden bg-white/60 backdrop-blur-sm",
  leftColumnBorder: "border-blue-200",
  rightColumnBorder: "border-green-200",

  // Column header
  columnHeader:
    "py-2 font-semibold text-md sm:text-lg rounded-t-2xl text-center",
  leftColumnHeader: "bg-blue-100 text-blue-700",
  rightColumnHeader: "bg-green-100 text-green-700",

  // Scroll container
  scrollContainer:
    "h-56 sm:h-72 md:h-[360px] lg:h-[400px] overflow-y-hidden no-scrollbar p-3 sm:p-4",

  // Testimonial card
  testimonialCard:
    "bg-white font-[pacifico] rounded-xl shadow-lg p-4 sm:p-5 mb-4 transition-transform duration-300 border-l-4 w-full max-w-xl mx-auto",
  ...
  avatar:
    "w-12 h-12 sm:w-14 sm:h-14 object-cover rounded-full border border-gray-200 shadow-sm",
...
export const serviceDetailStyles = {
  // Page container
  pageContainer:
    "min-h-screen font-serif bg-gradient-to-br from-emerald-50 via-white to-green-50 px-4 lg:px-12 pt-20 sm:pt-12 md:pt-8 lg:pt-0",

  // Navigation bar
  navBar: "backdrop-blur-lg top-0 z-20",
  navContainer: "max-w-6xl mx-auto h-16 flex items-center justify-between px-4",
  backButton:
    "inline-flex items-center gap-2 px-4 py-2 bg-white text-emerald-600 border border-emerald-200 rounded-full hover:bg-emerald-50",

  // Main grid layout
  mainGrid:
    "max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 mt-6",
  ...
  // Image
  imageContainer:
    "w-full h-56 sm:h-72 md:h-96 lg:h-[65vh] xl:h-[70vh] rounded-3xl overflow-hidden shadow-2xl border border-white/50",
  image:
  ...
  detailsTitle:
    "text-lg font-semibold text-emerald-700 flex items-center gap-2 mb-4",
  ...
  emailInput:
    "px-4 py-3 rounded-full border border-emerald-200 focus:ring-2 focus:ring-emerald-300 w-full sm:col-span-2",
  ...
  // Right column
  rightColumn:
    "bg-white/80 rounded-3xl shadow-xl p-6 sm:p-8 border border-white/50 h-fit",
  serviceName:
    "text-2xl lg:text-3xl xl:text-3xl md:text-2xl sm:text-4xl font-bold bg-gradient-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent",

  // About section
  aboutContainer: "mt-6 bg-emerald-50 p-5 rounded-xl border border-emerald-100",
  aboutTitle:
    "flex items-center gap-3 text-md md:text-xl lg:text-xl xl:text-xl font-semibold text-emerald-900",
  aboutText: "text-emerald-800 mt-2",

  // Price display
  priceContainer:
    "mt-6 rounded-full flex items-center gap-3 bg-emerald-50 w-fit px-5 py-3 border border-emerald-100",
  ...
  // Booking summary
  summaryContainer:
    "mt-8 bg-gradient-to-r from-emerald-50 to-green-50 rounded-2xl p-5 border border-emerald-100",
  ...
  backToServices:
    "inline-block mt-4 px-4 py-2 bg-emerald-600 text-white rounded-full",
};
...
export const doctorDetailStyles = {
  // Main container
  pageContainer:
    "min-h-screen font-serif bg-gradient-to-br from-emerald-50 via-white to-green-50 relative overflow-hidden",
  ...
  backButton:
    "inline-flex items-center gap-2 mt-4 px-6 py-3 bg-emerald-500 text-white rounded-full hover:bg-emerald-600 transition-all",
  ...
  // Header
  headerContainer:
    "relative z-10 bg-white/80 backdrop-blur-lg border-b border-emerald-100 top-0",
  headerContent: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",
  headerFlex: "flex items-center justify-between h-16",
  headerBackButton:
    "inline-flex items-center gap-2 px-2 xl:px-4 lg:px-4 py-2 bg-white text-emerald-600 border border-emerald-200 rounded-full hover:bg-emerald-50 hover:border-emerald-300 transition-all duration-300 shadow-sm hover:shadow-md",
  headerBackButtonIcon: "size={18}",
  headerBackButtonText: "font-medium",
  headerTitle:
    "text-sm md:text-2xl lg:text-xl xl:text-2xl whitespace-nowrap font-bold bg-gradient-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent",
  headerRatingContainer:
    "flex items-center gap-2 px-2 py-2 bg-white rounded-full shadow-sm border border-amber-100",
  headerRatingIcon: "text-amber-400 fill-current",
  headerRatingText: "font-semibold text-amber-600",

  // Main content wrapper
  mainContent:
    "relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-20 sm:pt-8 transition-all duration-700",
  visibleState: "opacity-100 translate-y-0",
  hiddenState: "opacity-0 translate-y-8",

  // Profile card
  profileCard:
    "bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/50 overflow-hidden mb-8",
  profileGrid:
    "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-6 sm:p-8",

  // Left column (avatar)
  leftColumn: "lg:col-span-1 flex flex-col items-center space-y-6",
  avatarContainer: "relative",
  avatarGlow:
    "absolute -inset-2 sm:-inset-3 md:-inset-6 bg-gradient-to-br from-emerald-400 to-green-400 rounded-full blur-lg opacity-50 animate-pulse",
  avatarImage:
    "relative w-32 h-32 sm:w-40 sm:h-40 md:w-56 md:h-56 lg:w-64 lg:h-64 rounded-full object-cover border-4 sm:border-6 md:border-8 border-white shadow-2xl z-10 transition-transform duration-300",
  statsGrid:
    "grid grid-cols-2 md:grid-cols-2 xl:grid-cols-3 lg:grid-cols-2 gap-4 w-full max-w-lg px-2",
  statBox:
    "text-center p-3 sm:p-4 bg-white rounded-2xl shadow-lg border border-emerald-50 hover:shadow-xl transition-all duration-300 hover:-translate-y-1",
  ...
  doctorName:
    "text-2xl md:text-2xl lg:text-3xl xl:text-3xl sm:text-4xl font-bold bg-gradient-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent",
  specializationBadge:
    "inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-emerald-400 to-green-500 text-white rounded-full text-sm font-semibold shadow-lg",
  badgeIcon: "w-4 h-4",

  // Info grid
  infoGrid: "grid grid-cols-1 lg:grid-cols-2 md:grid-cols-1 gap-4",
  infoItem:
    "flex items-start gap-3 md:p-3 p-4 bg-white rounded-full shadow-sm border border-emerald-50",
  ...
  appointmentContainer:
    "bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/50 overflow-hidden",
  appointmentContent: "p-6 sm:p-8",
  appointmentHeader: "flex items-center gap-3 mb-6",
  appointmentIcon: "w-6 h-6 text-emerald-500",
  appointmentTitle:
    "text-md md:text-2xl font-bold bg-gradient-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent",
  ...
  dateTitle:
    "text-lg md:text-xl font-semibold text-emerald-700 flex items-center gap-2",
  dateTitleIcon: "w-5 h-5",
  dateScrollContainer: "overflow-x-auto -mx-2 px-2",
  dateButtonsContainer:
    "inline-grid grid-flow-col auto-cols-max gap-3 sm:grid sm:grid-flow-row sm:auto-cols-auto sm:grid-cols-3 md:grid-cols-7 lg:grid-cols-5 xl:grid-cols-6",
  dateButton:
    "p-2 sm:p-3 rounded-full cursor-pointer border-2 transition-all whitespace-nowrap",
  dateButtonSelected:
  ...
  timeSlotsTitle:
    "text-lg font-semibold text-emerald-700 flex items-center gap-2",
  timeSlotsIcon: "w-5 h-5",
  timeSlotsContainer:
    "flex gap-3 overflow-x-auto sm:grid sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-3",
  noSlotsMessage: "text-gray-500",
  timeSlotButton: "min-w-[140px] p-2 rounded-full border-2",
  timeSlotButtonSelected:
    "bg-gradient-to-br from-emerald-500 to-green-500 text-white border-emerald-500",
  ...
  // Summary section
  summaryContainer:
    "bg-gradient-to-r from-emerald-50 to-green-50 p-4 sm:p-6 rounded-2xl border border-emerald-100",
  ...
  // Booking button
  bookingButton:
    "w-full py-3 sm:py-4 px-4 rounded-full font-semibold text-sm cursor-pointer transition-all",
...
export const navbarStylesDr = {
  // Main navbar
  navContainer:
    "fixed top-8 left-1/2 -translate-x-1/2 z-50 w-full md:max-w-2xl lg:max-w-4xl px-4 py-0 rounded-full bg-white/80 backdrop-blur-md border border-emerald-100 shadow-2xl flex items-center justify-between gap-3 font-serif transition-all duration-300 hover:shadow-emerald-200/80 hover:-translate-y-0.5",

  // Left brand section
  leftBrand: "flex items-center gap-3",
  logoContainer:
    "w-20 h-20 flex items-center justify-center rounded-full transform transition-all duration-300 hover:rotate-1 overflow-hidden",
  ...
  // Link styles
  baseLink:
    "relative flex items-center gap-2 px-3 py-2 rounded-full text-sm font-medium transition-all duration-200 transform",
  activeLink:
    "bg-emerald-600 text-white shadow-lg scale-105 ring-2 ring-emerald-200",
  inactiveLink:
    "text-emerald-700 hover:bg-emerald-50 hover:text-emerald-900 hover:-translate-y-0.5 hover:shadow",
  ...
  logoutButtonDesktop:
    "hidden lg:flex items-center gap-2 px-4 py-2 rounded-full bg-white text-emerald-700 border border-emerald-200 shadow-sm text-sm font-semibold transition-all duration-200 transform hover:scale-105 hover:-translate-y-0.5",

  // Hamburger menu buttons
  hamburgerButtonMd:
    "md:hidden p-2 rounded-md hover:bg-emerald-50 transition-colors",
  hamburgerButtonLg:
    "hidden md:flex lg:hidden p-2 rounded-md hover:bg-emerald-50 transition-colors",

  // Mobile/tablet menu
  mobileMenuContainer: (isOpen) =>
    `lg:hidden fixed top-32 left-1/2 -translate-x-1/2 z-40 w-[92%] max-w-md bg-white/95 backdrop-blur-md border border-emerald-100 rounded-2xl shadow-lg transform origin-top transition-all duration-200 ${isOpen ? "scale-100 opacity-100 translate-y-0" : "scale-95 opacity-0 -translate-y-2 pointer-events-none"}`,
  ...
  mobileLogoutButton:
    "mt-2 px-4 py-2 rounded-full text-center bg-emerald-500 text-white font-semibold text-sm shadow-sm transition-transform duration-150 hover:scale-105 w-full",
...
export const listPageStyles = {
  // Main container
  pageContainer:
    "min-h-screen pt-20 md:pt-24 lg:pt-24 font-serif p-4 sm:p-6 bg-gradient-to-br from-emerald-50 to-white",
  ...
  headerTitle:
    "text-xl sm:text-xl pt-5 md:pt-0 lg:pt-0 xl:pt-0 font-extrabold text-emerald-900",
  headerSubtitle: "text-xs sm:text-sm text-emerald-700",

  // Search and filter section
  searchFilterContainer:
    "flex flex-col pt-10 md:pt-0 sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto",
  searchContainer: "relative w-full sm:w-auto",
  searchIconContainer:
    "absolute inset-y-0 left-3 flex items-center pointer-events-none text-emerald-400",
  searchIcon: "w-4 h-4",
  searchInput:
    "pl-10 pr-10 w-full sm:w-64 md:w-80 lg:w-96 py-2 rounded-full border border-emerald-200 bg-white text-emerald-800 focus:ring-2 focus:ring-emerald-200 outline-none",
  clearSearchButton:
    "absolute right-2 top-1/2 -translate-y-1/2 text-emerald-600 hover:text-emerald-900 p-1 rounded-full",
  clearSearchIcon: "w-4 h-4",
  statusFilter:
    "text-sm px-3 py-2 rounded-full border border-emerald-200 bg-white w-full sm:w-auto",
  ...
  // Appointments grid
  appointmentsGrid:
    "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 items-start",

  // Appointment card
  appointmentCard:
    "rounded-2xl p-4 bg-white shadow-sm border border-emerald-100 hover:shadow-md transition flex flex-col justify-between self-start",

  // Card header
  cardHeader: "flex flex-col sm:flex-row items-start sm:items-center gap-3",
  cardAvatar:
    "w-12 h-12 sm:w-14 sm:h-14 rounded-full overflow-hidden bg-emerald-50 border border-emerald-100 flex items-center justify-center",
  ...
  dateTimeContainer:
    "text-md md:text-lg text-emerald-800 font-bold flex items-center gap-2 w-full",
  ...
  statusBadgePending:
    "bg-yellow-100 text-amber-800 border border-amber-200 animate-pulse",

  // Status select
  statusSelect:
    "text-sm px-3 py-1 rounded-full border focus:outline-none transition",
  statusSelectEnabled:
  ...
  dateInput:
    "text-sm px-3 py-2 rounded-full border border-emerald-200 bg-white w-full md:w-40",
  timeInput:
    "text-sm px-3 py-2 rounded-full border border-emerald-200 bg-white w-full md:w-36",
  rescheduleButtons: "flex gap-2",
  saveButton:
    "text-sm px-3 py-2 rounded-full bg-emerald-600 text-white font-semibold hover:bg-emerald-700 transition",
  cancelButton:
    "text-sm px-3 py-2 rounded-full border border-emerald-200 bg-white text-emerald-800 hover:shadow-sm transition",
};
...
export const editProfilePageStyles = {
  // Page container
  pageContainer:
    "min-h-screen font-serif bg-gradient-to-br from-emerald-50 via-white to-emerald-50/30 p-4 sm:p-5 md:p-6",
  maxWidthContainer: "max-w-6xl pt-8 md:pt-10 mx-auto relative",

  // Loading states
  loadingContainer: "min-h-screen flex items-center justify-center",
  loadingSpinner:
    "w-12 h-12 border-4 border-gray-300 border-t-transparent rounded-full animate-spin mx-auto mb-4",
  loadingText: "text-gray-600",
  errorText: "text-red-600",

  // Toast notifications
  toastContainer:
    "fixed top-3 right-2 sm:right-4 z-50 space-y-3 max-w-xs sm:max-w-sm",
  toastBase:
    "transform transition-all duration-300 ease-out rounded-r-lg shadow-lg p-3 sm:p-4 flex items-start gap-3 animate-slideIn",
  toastSuccess:
  ...
  // Main card
  mainCard:
    "bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden border border-emerald-100/50",
  headerBackground:
    "relative h-24 sm:h-28 md:h-32 bg-gradient-to-r from-emerald-400 to-emerald-600",

  // Profile image
  imageContainer:
    "absolute -bottom-16 left-1/2 transform -translate-x-1/2 md:left-8 md:transform-none",
  imageWrapper: "relative group",
  profileImage:
    "relative w-24 h-24 sm:w-28 sm:h-28 md:w-36 md:h-36 md:ml-23 rounded-full object-cover border-4 border-white shadow-2xl",
  ...
  profileHeader:
    "flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8",
  profileInfo: "flex-1 min-w-0",
  profileName:
    "text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-emerald-700 to-emerald-900 bg-clip-text text-transparent truncate",
  profileSubtitle:
    "text-sm sm:text-lg text-emerald-700 mt-2 flex items-center gap-2",
  subtitleIcon: "w-4 h-4",

  // Stats container
  statsContainer: "mt-4 flex flex-wrap items-center gap-3",
  statItem:
    "flex items-center gap-3 bg-white px-3 py-2 rounded-full border border-emerald-100 shadow-sm text-sm sm:text-base",
  ratingStatItem:
    "flex items-center gap-3 bg-gradient-to-r from-amber-50 to-amber-100 px-3 py-2 rounded-full border border-amber-200 text-sm sm:text-base",
  feeStatItem:
    "flex items-center gap-1 bg-gradient-to-r from-amber-50 to-amber-100 px-3 py-2 rounded-full border border-amber-200",
  statIcon: "w-4 h-4",
  ...
  editButton:
    "group relative overflow-hidden bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white px-5 py-2 rounded-full cursor-pointer shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-[1.02] w-full sm:w-auto",
  editButtonContent: "relative flex items-center gap-2",

  // Form sections
  formSection: "mb-8",
  sectionTitle:
    "text-xl sm:text-2xl font-bold text-emerald-900 mb-6 flex items-center gap-2",
  ...
  emptySchedule:
    "text-center py-10 rounded-2xl border-2 border-dashed border-emerald-200 bg-emerald-50/50",
  ...
  // Date card
  dateCard:
    "group relative bg-gradient-to-br from-white to-emerald-50 p-4 sm:p-5 rounded-2xl border border-emerald-100 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1",
  dateHeader:
    "flex items-center justify-between mb-3 pb-3 border-b border-emerald-100",
  ...
  dateSlotCount:
    "text-xs font-medium px-3 py-1 rounded-full bg-emerald-100 text-emerald-700",
  ...
  timeSlotItem:
    "flex items-center justify-between bg-white px-3 py-2 rounded-full border border-emerald-100 hover:border-emerald-200 transition-colors",
  ...
  addSlotInput:
    "flex-1 rounded-full px-3 py-2 text-sm border border-emerald-200 bg-white focus:outline-none focus:ring-2 focus:ring-emerald-200",
  addSlotButton:
    "p-2 rounded-full cursor-pointer bg-emerald-100 text-emerald-700 hover:bg-emerald-200 transition-colors",
  addSlotIcon: "w-4 h-4",
  ...
  // Actions section
  actionsSection:
    "flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-emerald-100",
  actionsText: "text-sm text-gray-500",
  actionsButtons:
    "flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto",
  resetButton:
    "px-6 py-3 rounded-full cursor-pointer border-2 border-emerald-200 text-emerald-700 hover:bg-emerald-50 hover:border-emerald-300 transition-all duration-200 font-medium w-full sm:w-auto text-center",
  saveButton:
  ...
  addDateInput:
    "rounded-xl px-3 py-2 border-2 border-emerald-200 bg-white focus:outline-none focus:ring-2 focus:ring-emerald-200 focus:border-emerald-400 text-sm sm:text-base",
  addDateButton:
    "flex items-center gap-2 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white px-4 py-2 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 text-sm sm:text-base",
  addDateIcon: "w-4 h-4",
...
export const dashboardStyles = {
  // Main container
  pageContainer:
    "min-h-screen font-serif pt-16 lg:pt-20 md:pt-15 p-4 sm:p-6 bg-gradient-to-br from-emerald-50 to-white",
  ...
  headerContainer:
    "mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4",
  headerTitle:
    "text-2xl pt-10 xl:pt-0 uppercase lg:pt-0 sm:text-3xl font-extrabold tracking-tight text-emerald-900",
  headerSubtitle: "text-sm sm:text-base text-emerald-700/70",
  headerInfo: "text-sm text-slate-600",
  refreshButton:
    "text-sm px-3 py-1 rounded-full bg-white text-emerald-600 border border-emerald-200 hover:shadow-sm",

  // Stats grid
  statsGrid:
    "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8",

  // Stat card
  statCard:
    "rounded-full p-4 bg-white/60 backdrop-blur-sm border border-emerald-300 shadow-sm hover:shadow-md transition-all",
  statContent: "flex items-center justify-between gap-4",
  statTextContainer: "flex-1",
  statTitle: "text-sm font-medium text-emerald-800/80",
  statValue:
    "mt-2 text-xl sm:text-2xl font-extrabold text-emerald-900 tracking-tight",
  statIconContainer: "p-3 rounded-full bg-gradient-to-br border shadow-md",
  ...
  appointmentsContainer:
    "bg-white/60 backdrop-blur-sm rounded-2xl p-4 border border-emerald-100 shadow-sm",
  ...
  appointmentsTotal:
    "text-sm sm:text-base text-emerald-700 flex items-center gap-2",
  totalIcon: "w-4 h-4",

  // Cards grid
  cardsGrid:
    "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 items-start",

  // Appointment card
  appointmentCard:
    "rounded-xl p-4 bg-white shadow-sm border border-emerald-100 flex flex-col justify-between gap-4 hover:shadow-md transition self-start",
  ...
  cardPhoneContainer:
    "mt-2 text-xs sm:text-sm text-emerald-600 flex items-center gap-2",
  ...
  showMoreButton:
    "px-4 py-2 rounded-full bg-emerald-600 text-white text-sm font-semibold hover:bg-emerald-700 transition",
  ...
  // Status select
  statusSelect:
    "text-xs sm:text-sm px-3 py-1 rounded-full border focus:outline-none transition",
  statusSelectEnabled:
    "bg-white text-emerald-800 border-emerald-200 hover:shadow-sm",
  statusSelectDisabled:
    "bg-gray-50 text-gray-400 cursor-not-allowed border-gray-200",
  ...
  rescheduleDateInput:
    "text-xs px-3 py-2 rounded-full border border-emerald-200 bg-white w-full md:w-48 lg:w-56",
  rescheduleTimeInput:
    "text-xs px-3 py-2 rounded-full border border-emerald-200 bg-white w-full md:w-48 lg:w-56",
  rescheduleButtons: "flex gap-2",
  saveButton:
    "text-xs px-3 py-2 rounded-full bg-emerald-600 text-white font-semibold hover:bg-emerald-700 transition",
  cancelButton:
    "text-xs px-3 py-2 rounded-full border border-emerald-200 bg-white text-emerald-800 hover:shadow-sm transition",
};
