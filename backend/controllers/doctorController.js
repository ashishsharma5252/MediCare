...
//HELPER FUNCTIONS
// parse time string like "2:30 PM" to total minutes from midnight
...
// this function will remove duplicate time slot and return the slot filter by time
...
export const createDoctor = async (req, res) => {
  try {
    ...
    if (!secret) {
      console.warn("JWT secret key is not defined in environment variables");
...
// to get all doctors with pagination and search
...
// to toggle availability of doctor
