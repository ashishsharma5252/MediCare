...
//  HELPER FUNCTIONS
// this function will return a finit number
...
// this function will parse the time and return the AM/PM
...
//this function will create the frontendurl
...
function resolveClerkUserId(req) {
  try {
    ...
    try {
      ...
      const result = serverAuth?.userId || null;
      return result;
    } catch (e) {
    ...
    console.error("resolveClerkUserId error:", e);
    return null;
  }
}

// to create a service apppointment
...
export const updateServiceAppointment = async (req, res) => {
  try {
    ...
    const updated = await ServiceAppointment.findByIdAndUpdate(id, {
      $set: updates,
      new: true,
      runValidators: true,
    });
...
// to cancke tge service appointment
