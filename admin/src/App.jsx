      ...
      <div className="min-h-screen font-mono flex items-center justify-center bg-linear-to-b from-emerald-50 via-green-50 to-emerald-100 px-4">
        <div className="text-center">
          ...
          <div className="flex justify-center">
            <Link
              to="/"
              className="px-4 py-2 text-sm rounded-full bg bg-emerald-600 text-white shadow-sm hover:bg-emerald-700 hover:shadow-md transition-all duration-300 ease-in-out animate-bounce-subtle "
            >
              Home
            </Link>
          </div>
  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          <RequireAuth>
            {/* data shown is from the service-appointments not from services check in last */}
            <SerDashboard />
          </RequireAuth>
        }
      />
