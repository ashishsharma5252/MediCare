...
const AddService = ({ serviceId }) => {
  ...
  //   initials values as strings matching options
  ...
  // compute the days for selected month and year(respecting the month length)
  ...
  //   user can't select the previous year, month or date from today's date
  useEffect(() => {
  ...
  return (
    <div className={addServiceStyles.container.main}>
      <div className={addServiceStyles.toast.container}>
        {toast && (
          <div
            className={`${addServiceStyles.toast.toastBase} ${toast.type === "error" ? addServiceStyles.toast.toastError : toast.type === "info" ? addServiceStyles.toast.toastInfo : addServiceStyles.toast.toastSuccess} animate-slideIn`}
          >
