...
export default function ListServicePage() {
  ...
  //   sort the slots as latestcome first by date
  ...
  //   to convert array of slots into slot object
  ...
  //   formate the slot for backend ex-DD-MM-YYYY with HH:MM AM/PM
  ...
  //   to slot obj to timestamp in local time zone
