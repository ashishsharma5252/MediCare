...
// HELPER FUNCTIONS
// this function return the date as 22 may 2026
...
// this function takes slot with date time and return a date obj.
...
const AppointmentsPage = () => {
  ...
  useEffect(() => {
    async function load() {
      ...
      try {
        ...
        setAppointments(items); //fetch all the details present on the DM.
      } catch (err) {
  ...
  // if admin want to cancel the appt
