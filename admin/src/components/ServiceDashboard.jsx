...
// function to normalize the backend data that is coming from the DB
...
const ServiceDashboard = ({ services: servicesProp = null }) => {
  ...
  useEffect(() => {
    ...
    // also refresh the tab when become visible
  ...
  return (
    <div className={serviceDashboardStyles.container}>
      <div className={serviceDashboardStyles.innerContainer}>
        ...
        {/* search bar */}
        <div className={serviceDashboardStyles.searchContainer}>
        ...
        {/* table list */}
        <div className={serviceDashboardStyles.tableContainer}>
          {/* for medium screens */}
        ...
        {filteredServices.length > INITIAL_COUNT && (
          <div className={serviceDashboardStyles.showMore.container}>
            ...
            >
              {showAll
                ? "Show Less"
                : `Show more (${filteredServices.length - INITIAL_COUNT} more)`}
            </button>
          </div>
        )}
      </div>
